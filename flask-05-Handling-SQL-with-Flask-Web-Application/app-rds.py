...
response = ssm.get_parameter(Name='/clarusway/juliet/password')
pw = response['Parameter']['Value']
response = ssm.get_parameter(Name='/clarusway/juliet/endpoint')
db = response['Parameter']['Value']
